...
public class opti {
    ...
    public static void VCS() {
        ...
        boolean fo=true;
        while(fo){
            for (in= 0;in <pump.length; in++){
                if(pump[0][in+1]!=null ){
                    if(pump[0][in].compareTo(pump[0][in+1])>0){

                        String temp = pump[0][in];
                        pump[0][in] = pump[0][in+1];
                        pump[0][in+1]=temp;
                    }
                }
                count++;
        ...
        while(fo){
            for (in= 0;in <pump.length; in++){
                if(pump[1][in+1]!=null ){
                    if(pump[1][in].compareTo(pump[1][in+1])>0){

                        String temp = pump[1][in];
                        pump[1][in] = pump[1][in+1];
                        pump[1][in+1]=temp;
                    }
                }
                count++;
        ...
        while(fo){
            for (in= 0;in <pump.length; in++){
                if(pump[2][in+1]!=null ){
                    if(pump[2][in].compareTo(pump[2][in+1])>0){

                        String temp = pump[2][in];
                        pump[2][in] = pump[2][in+1];
                        pump[2][in+1]=temp;
                    }
                }
                count++;
